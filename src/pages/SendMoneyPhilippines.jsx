          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-green-100">
            <div className="text-center">
              ...
              <p className="text-lg lg:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                Send money to Philippines for business using our secure platform, which offers competitive <span className="font-semibold text-green-600">USD to PHP</span> exchange rates and fast transfers of funds to any Philippine bank, including <span className="font-semibold">BDO Unibank, BPI, or Metrobank</span>.
              </p>

...
function SendMoneyPhilippines() {
  ...
  useEffect(() => {
    document.title = "Send Money From USA To Philippines Ultra-Low Fees, Zero Hassle";
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-green-100">
            <div className="text-center">
              ...
              <p className="text-lg lg:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                Send business payments to Philippines using our secure platform, offering competitive <span className="font-semibold text-green-600">USD to PHP</span> exchange rates and fast transfers to major Philippine banks, including <span className="font-semibold">BDO Unibank, BPI, and Metrobank</span>.
              </p>

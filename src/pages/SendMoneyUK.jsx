          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="animate-fade-in-up">
              ...
              <div className="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-full text-sm font-medium mb-8 shadow-lg">
                💸 Best USD to GBP rates for UK transfers
              </div>
              
              <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                <span className="block">Send Money From USA</span>
                <span className="block gradient-text">To UK</span>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-green-100">
            <div className="text-center">
              ...
              <p className="text-lg lg:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                Send money to UK for business with our secure platform, featuring competitive <span className="font-semibold text-green-600">USD to GBP</span> exchange rates and fast transfers of funds to any UK bank, like <span className="font-semibold">HSBC, Barclays, or Lloyds Bank</span>.
              </p>

          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="animate-fade-in-up">
              ...
              <div className="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-full text-sm font-medium mb-8 shadow-lg">
                💸 Best USD to INR rates for India transfers
              </div>
              
              <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                <span className="block">Send Money From USA</span>
                <span className="block gradient-text">To INDIA</span>
              ...
              <p className="text-lg lg:text-xl text-gray-600 mb-8 leading-relaxed max-w-lg">
                International business payments in minutes with lowest fees and best USD to INR rates. Fast transfers to SBI, HDFC, or ICICI.
              </p>
              ...
              <p className="text-sm text-gray-500 mt-4">
                Trusted by thousands of businesses sending money to India
              </p>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-green-100">
            <div className="text-center">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                Instant Business Payments to India
              </h2>
              <p className="text-lg lg:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                Send your business payments to Indian suppliers with real-time <span className="font-semibold text-green-600">USD to INR</span> exchange rates and instant processing. Whether it's <span className="font-semibold">SBI, HDFC, ICICI</span>, or any Indian bank, your money reaches its destination quickly and safely.
              </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            ...
            <a href="/send-money-india" className="bg-green-600 text-white p-4 rounded-lg text-center font-semibold hover:bg-green-700 transition-colors flex flex-col items-center gap-2">
              <img src="https://flagcdn.com/w40/in.png" alt="India flag" className="w-8 h-6 object-cover rounded" />
              <span>India</span>
            </a>
            <a href="/send-money-philippines" className="bg-white border-2 border-gray-200 p-4 rounded-lg text-center font-semibold hover:border-green-600 hover:text-green-600 transition-colors flex flex-col items-center gap-2">
            ...
            <a href="/send-money-italy" className="bg-white border-2 border-gray-200 p-4 rounded-lg text-center font-semibold hover:border-green-600 hover:text-green-600 transition-colors flex flex-col items-center gap-2">

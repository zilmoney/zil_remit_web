        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Send your business payments to Indian suppliers with real-time USD to INR exchange rates and instant processing. Whether it's SBI, HDFC, ICICI, or any Indian bank, your money reaches its destination quickly and safely.
            </p>
          </div>
        </div>
      </section>

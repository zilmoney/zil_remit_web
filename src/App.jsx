          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-fade-in-up">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="https://app.zilremit.com/signup" className="bg-green-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-green-700 transition-colors text-center">
                  Start Business Payments →
                </a>
                <a href="https://calendly.com/zmn/demo" className="border-2 border-green-600 text-green-600 px-8 py-4 rounded-lg font-semibold hover:bg-green-50 transition-colors text-center">
                  Book A Demo →
                </a>
              </div>
            </div>

            {/* Right - Business Payments Image */}
            <div className="animate-fade-in-right">
              <img src="business_payments.png" alt="Business Payments Success Interface" className="w-full h-auto rounded-2xl shadow-2xl" />
            </div>
          </div>
        </div>
      </section>
